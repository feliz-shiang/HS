...
@property (nonatomic,assign)NSString * beCash;                //
@property (nonatomic,assign)NSString *  beReach;               //
@property (nonatomic,assign)NSString *  beSell;                //
@property (nonatomic,assign)NSString *  beTake;                //
@property (nonatomic,assign)NSString *  beTicket;              //
