...
@property (copy , nonatomic) NSString *heightAuction;//最高竞价
...
// add by songjk
@property (strong, nonatomic) NSString * strRuleID; //  折扣id
// add by songjk
@property (strong, nonatomic) NSString * isApplyCard; //  是否可以申请互生卡
@property (strong, nonatomic) NSString * postage; // 快递费
@property (strong, nonatomic) NSString * postageMsg; // 快递信息
@end
