...
//    vFront.backgroundColor = [UIColor colorWithRed:253/255.0 green:243/255.0 blue:221/255.0 alpha:1.0];
    vFront.backgroundColor = kConfirmDialogBackgroundColor;
    ...
    [ivStatus setImage:[UIImage imageNamed:@"img_succeed"]];
...
//    btnConfrim.backgroundColor = [UIColor redColor];
    UIImage *imConfrim = [UIImage imageNamed:@"alert_btn_confirm_bg"];
...
-(void)layoutSubviews
{
    ...
    if (self.bSuccess) { // 业务办理成功
        ...
        CGFloat lbTitleW = [self.strResultInfo sizeWithFont:kTitleFont].width;
        CGFloat lbTitleH = 40;
    ...
    {
        NSString * strErrorTitle = @"处理失败";
        CGFloat ivStatusW = 25;
        CGFloat ivStatusH = ivStatusW;
        CGFloat ivStatusX = 0;
        CGFloat ivStatusY = boder * 3;
        
        CGFloat lbTitleW = [strErrorTitle sizeWithFont:kTitleFont].width;
        CGFloat lbTitleH = 40;
        CGFloat lbTitleY = ivStatusY;
        
        ivStatusX = (vFrontW - (lbTitleW + boder + ivStatusW))*0.5;
        NSString *strPath = [[NSBundle mainBundle] pathForResource:@"img_faild.png" ofType:nil];
        [self.ivStatus setImage:[UIImage imageWithContentsOfFile:strPath]];
        self.ivStatus.frame = CGRectMake(ivStatusX, ivStatusY, ivStatusW, ivStatusH);
...
//        vLine1.backgroundColor = [UIColor grayColor];
        [vLine1 setImage:[UIImage imageNamed:@"line_confirm_dialog_yellow"]];
//        vLine1.alpha = 0.3;
        ...
        CGFloat lbMessageH = [Utils heightForString:self.strResultInfo  font:kMsgFont width:lbMessageW];
...
//        vLine2.alpha = 0.3;
        [vLine2 setImage:[UIImage imageNamed:@"line_confirm_dialog_yellow"]];
