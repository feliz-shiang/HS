...
@interface GYShopCategoryChooseController ()
...
@implementation GYShopCategoryChooseController
...
//    NSString * strcategoryName = arrList[indexPath.row];
    ...
    GYSearchShopGoodsViewController * vcSearch = [[GYSearchShopGoodsViewController alloc] init];
    vcSearch.vshopId = self.strShopID;
    vcSearch.delegate = self.pushedVC;
