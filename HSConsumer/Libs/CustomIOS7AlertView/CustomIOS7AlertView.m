...
- (UIView *)createContainerView
{
    ...
    self.lineView1.image = [UIImage imageNamed:@"line_confirm_dialog_yellow.png"];
    ...
    self.lineView.image = [UIImage imageNamed:@"line_confirm_dialog_yellow.png"];
        ...
        if (self.arrBtnBackColor&&self.arrBtnBackColor.count>0)
        {
            if (self.arrIndesx.count&&self.arrIndesx.count>0)
            {
                for (NSString * strIndex in self.arrIndesx) {
                    ...
                    {
                        [closeButton setBackgroundImage:[UIImage imageNamed:@"alert_btn_confirm_bg.png"] forState:UIControlStateNormal];
                    }
                }
            }
        }
