...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message buttonTitles:(NSArray *)buttonTitles buttonStyle:(JGActionSheetButtonStyle)buttonStyle {
    ...
    if (self) {
        if (title) {
            ...
            titleLabel.textColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:1.0f];
...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    if (buttonStyle == JGActionSheetButtonStyleDefault) {
        ...
        borderColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
    }
    ...
    else if (buttonStyle == JGActionSheetButtonStyleHSDefaultGray) {
        font = [UIFont systemFontOfSize:18.0f];
        titleColor = rgb(90.0f, 90.0f, 90.0f);
        
        backgroundColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
        borderColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
    }
    else if (buttonStyle == JGActionSheetButtonStyleHSDefaultRed) {
        font = [UIFont systemFontOfSize:18.0f];
        titleColor = rgb(230.f, 80.f, 55.f);
        
        backgroundColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
        borderColor = rgb(230.f, 230.f, 230.f);
    }
    else if (buttonStyle == JGActionSheetButtonStyleHSDefaultyellow) {
        font = [UIFont systemFontOfSize:18.0f];
        titleColor = rgb(239.f, 134.f, 57.f);
...
- (JGButton *)makeButtonWithTitle:(NSString *)title style:(JGActionSheetButtonStyle)style {
    ...
    b.layer.backgroundColor = (__bridge CGColorRef)([UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0f]);
...
//    UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(0,1, 300, 1)];
//    lable.backgroundColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0f];
//    [b addSubview:lable];
//    
...
- (CGRect)layoutForWidth:(CGFloat)width {
    ...
    if (self.titleLabel) {
        height += spacing;//titlelable高度
        
        [self.titleLabel sizeToFit];
        height += CGRectGetHeight(self.titleLabel.frame);
        
        self.titleLabel.frame = (CGRect){{0, spacing}, {width, CGRectGetHeight(self.titleLabel.frame)}};
        self.titleLabel.frame = CGRectMake(self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y , self.titleLabel.frame.size.width, self.titleLabel.frame.size.height +20);
        
        
        //分隔线
        UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(0,CGRectGetHeight(self.titleLabel.frame), 300, 1)];
        lable.backgroundColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0f];
        
        [self.titleLabel addSubview:lable];
...
#pragma clang diagnostic pop
        ...
        self.messageLabel.frame = (CGRect){{spacing, height}, {width, messageLabelHeight}};
    ...
    for (UIButton *button in self.buttons) {
        ...
        button.layer.borderColor = [[UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0f]CGColor];


        
        button.frame = (CGRect){{0, height-5}, {width, buttonHeight+10}};
    ...
    if (self.contentView) {
        ...
        self.contentView.frame = (CGRect){{spacing, height}, {width, self.contentView.frame.size.height}};
