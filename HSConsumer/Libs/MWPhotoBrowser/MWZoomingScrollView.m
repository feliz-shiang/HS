...
- (void)imageView:(UIImageView *)imageView singleTapDetected:(UITouch *)touch { 
    ...
    [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(dismissViewControllerWithSingleTapDetected:) object:nil];
    [self performSelector:@selector(dismissViewControllerWithSingleTapDetected:) withObject:nil afterDelay:0.3];
}
...
- (void)view:(UIView *)view singleTapDetected:(UITouch *)touch {
    ...
    [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(dismissViewControllerWithSingleTapDetected:) object:nil];
    [self performSelector:@selector(dismissViewControllerWithSingleTapDetected:) withObject:nil afterDelay:0.4];
}
...
- (void)dismissViewControllerWithSingleTapDetected:(id)sender
{
    if (_photoBrowser.clickDismissPhotoBrowser)
    {
