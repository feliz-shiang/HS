...
- (void)addBottomBorderWithBorderWidth:(CGFloat)borderWidth andBorderColor:(UIColor *)color
{
    ...
    bottomBorder.frame = CGRectMake(0, CGRectGetHeight(self.frame), CGRectGetWidth(self.frame), borderWidth);
...
- (void)addRightBorderWithBorderWidth:(CGFloat)borderWidth andBorderColor:(UIColor *)color
{
    ...
    rightBorder.frame = CGRectMake(CGRectGetWidth(self.frame), 0, borderWidth, CGRectGetHeight(self.frame));
...
- (void)setBottomBorderInset:(BOOL)isInset
{
    ...
    {
        if (isInset)
            l.frame = CGRectMake(0, CGRectGetHeight(self.frame) - l.frame.size.height, CGRectGetWidth(self.frame), l.frame.size.height);
        else
            l.frame = CGRectMake(0, CGRectGetHeight(self.frame), CGRectGetWidth(self.frame), l.frame.size.height);
    }
}
...
- (void)setRightBorderInset:(BOOL)isInset
{
    ...
    {
        if (isInset)
            l.frame = CGRectMake(CGRectGetWidth(self.frame) - l.frame.size.width, 0, l.frame.size.width, CGRectGetHeight(self.frame));
        else
            l.frame = CGRectMake(CGRectGetWidth(self.frame), 0, l.frame.size.width, CGRectGetHeight(self.frame));
